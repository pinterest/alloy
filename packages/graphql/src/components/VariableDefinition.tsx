 ...
 * ```tsx
 * <>
 *   <VariableDefinition name="id" type={<TypeReference type={builtInScalars.ID} required />} />
 *   <VariableDefinition name="limit" type={<TypeReference type={builtInScalars.Int} />} defaultValue={10} />
 *   <VariableDefinition name="includeDeleted" type={<TypeReference type={builtInScalars.Boolean} />} defaultValue={false} />
 * </>
 * ```
 * renders to
 * ```graphql
...
export function VariableDefinition(props: VariableDefinitionProps) {
  // Validate that the type is a TypeReference component
  validateTypeReference(props.type, props.name, "Variable");
