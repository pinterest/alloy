...
struct LargeDeltas {
    1: required Bools b1,
    10: required Bools b10,
    100: required Bools b100,
    500: required bool check_true,
    1000: required Bools b1000,
    1500: required bool check_false,
    2000: required VersioningTestV2 vertwo2000,
    2500: required set<string> a_set2500,
    3000: required VersioningTestV2 vertwo3000,
    4000: required list<i32> big_numbers,
}
...
struct NestedMixedx2 {
    1: required list<set<i32>> int_set_list,
    2: required map<i32, set<string>> map_int_strset,
    3: required list<map<i32, set<string>>> map_int_strset_list,
}
